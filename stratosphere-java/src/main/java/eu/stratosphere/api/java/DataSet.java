...
public abstract class DataSet<T> {
	...
	public AggregateOperator<T> sum (int field) {
		return new AggregateOperator<T>(this, Aggregations.SUM, field);
	}
	...
	public AggregateOperator<T> max (int field) {
		return new AggregateOperator<T>(this, Aggregations.MAX, field);
	}
	...
	public AggregateOperator<T> min (int field) {
		return new AggregateOperator<T>(this, Aggregations.MIN, field);
	}
